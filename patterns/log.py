...
# Problem when we want to add filtering to all loggers, lot of subclassing!

# 1- Adapters (use duck typing - no inheritance involved)
...
logger = FilteredLogger('Error', fs) #  DUCK TYPING IMPLEMENTATION OF WRITE AND FLUSH
...
logger.log('Error: adapter, this is important!')
